...
void Main() {
  ...
  while (System::Update()) {
    ...
    Circle{ Scene::CenterF() + 100 * d_pendulum.get_coordinate0(), 5.0}.draw(Palette::Black);
    Circle{ Scene::CenterF() + 100 * d_pendulum.get_coordinate1(), 5.0 }.draw(Palette::Black);

    Line{ Scene::CenterF(), Scene::CenterF() + 100 * d_pendulum.get_coordinate0() }.draw(Palette::Green);
    Line{ Scene::CenterF() + 100 * d_pendulum.get_coordinate0(), Scene::CenterF() + 100 * d_pendulum.get_coordinate1() }.draw(Palette::Green);

    points << Scene::CenterF() + 100 * d_pendulum.get_coordinate1();
