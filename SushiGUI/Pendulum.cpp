...
void SimplePendulum::set_scale(double scale) {
  this->scale = scale;
}
double SimplePendulum::get_scale(void) const {
  return this->scale;
}
void SimplePendulum::set_offset(const Vec2& offset) {
  this->offset = offset;
}
Vec2 SimplePendulum::get_offset(void) const {
  return this->offset;
}
